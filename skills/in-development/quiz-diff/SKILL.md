...
### 2. สร้าง syllabus แล้วแจ้ง user

บอก user ก่อนเริ่ม: มีกี่ item, config ที่ใช้, และกติกา — **ตอบผิดจะไม่เฉลย** จะถามใหม่
...
### 3. Quiz loop — ทีละ 1 คำถาม 4 ตัวเลือก
